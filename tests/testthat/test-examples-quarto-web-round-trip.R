...
test_that("examples/quarto-web/docs/advanced/jupyter/kernel-execution.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/advanced/jupyter/kernel-execution.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_cross-reference-divs-table.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_cross-reference-divs-table.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_cross-reference-divs-video.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_cross-reference-divs-video.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_cross-references-callouts.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_cross-references-callouts.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_cross-references-listings.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_cross-references-listings.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_embed-examples/sample.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_embed-examples/sample.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_figure-examples/_examples.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_figure-examples/_examples.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/customize.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/customize.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/dark.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/dark.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/darkly.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/darkly.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/default.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/default.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/forest.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/forest.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/neutral.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/neutral.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/sandstone.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/sandstone.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/solar.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/solar.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/_mermaid-examples/vapor.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/_mermaid-examples/vapor.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/create-citeable-articles.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/create-citeable-articles.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/cross-reference-options.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/cross-reference-options.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/cross-references-custom.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/cross-references-custom.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/authoring/cross-references-divs.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/authoring/cross-references-divs.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/blog/posts/_quarto-1.3-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/blog/posts/_quarto-1.3-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/computations/execution-options.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/computations/execution-options.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/cell-layout.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/cell-layout.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/gapminder.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/gapminder.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/inputs/toolbar.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/inputs/toolbar.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/markdown.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/markdown.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/navigation.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/navigation.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/python-wide.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/python-wide.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/shiny-diamonds.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/shiny-diamonds.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/shiny-sidebar.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/shiny-sidebar.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/_examples/valuebox.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/_examples/valuebox.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/interactivity/index.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/interactivity/index.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/interactivity/observable.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/interactivity/observable.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/dashboards/interactivity/shiny-r.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/dashboards/interactivity/shiny-r.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/extensions/_extension-version.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/extensions/_extension-version.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/extensions/_shortcode-escaping.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/extensions/_shortcode-escaping.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/authoring/_authoring.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/authoring/_authoring.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/authoring/jupyter.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/authoring/jupyter.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/authoring/rstudio.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/authoring/rstudio.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/authoring/text-editor.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/authoring/text-editor.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/computations/index.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/computations/index.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/computations/jupyter.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/computations/jupyter.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/computations/neovim.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/computations/neovim.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/computations/rstudio.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/computations/rstudio.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/computations/text-editor.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/computations/text-editor.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/computations/vscode.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/computations/vscode.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/hello/rstudio/_hello.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/hello/rstudio/_hello.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/get-started/hello/text-editor.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/get-started/hello/text-editor.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/arquero.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/arquero.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/github.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/github.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/layout.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/layout.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/noaa-co2.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/noaa-co2.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/penguins.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/penguins.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/population.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/population.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/ojs/examples/sunburst.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/ojs/examples/sunburst.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/interactive/widgets/htmlwidgets.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/interactive/widgets/htmlwidgets.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/journals/_draft/create-extensions.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/journals/_draft/create-extensions.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/journals/_draft/extension-templates.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/journals/_draft/extension-templates.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_citations.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_citations.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_cross-refs.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_cross-refs.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_embeds-ipynb.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_embeds-ipynb.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_embeds-qmd.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_embeds-qmd.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_equations.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_equations.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_figures.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_figures.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_footer.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_footer.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_front-matter.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_front-matter.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_markdown.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_markdown.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_overview.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_overview.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_structure.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_structure.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_tables.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_tables.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_visual-editor.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_visual-editor.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_workflow-ipynb.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_workflow-ipynb.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_workflow-qmd.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_workflow-qmd.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/_workflow.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/_workflow.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/jupyterlab.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/jupyterlab.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/manuscripts/authoring/rstudio.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/manuscripts/authoring/rstudio.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/examples/gt-temps.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/examples/gt-temps.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/examples/pandas-temps.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/examples/pandas-temps.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/html-lightbox-figures.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/html-lightbox-figures.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/html-multi-format.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/html-multi-format.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/html-publishing.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/html-publishing.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/html-themes-more.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/html-themes-more.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/output-formats/ms-word-templates.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/output-formats/ms-word-templates.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/1.3/_pre-release-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/1.3/_pre-release-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/1.4/_pre-release-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/1.4/_pre-release-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/1.5/_pre-release-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/1.5/_pre-release-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/1.6/_pre-release-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/1.6/_pre-release-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/1.7/_pre-release-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/1.7/_pre-release-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/1.8/_pre-release-feature.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/1.8/_pre-release-feature.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/_highlights-prerelease.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/_highlights-prerelease.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/prerelease/_highlights-release.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/prerelease/_highlights-release.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/presentations/revealjs/advanced.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/presentations/revealjs/advanced.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/presentations/revealjs/demo/index.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/presentations/revealjs/demo/index.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/presentations/revealjs/demo/mini/zoom.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/presentations/revealjs/demo/mini/zoom.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/presentations/revealjs/examples/index.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/presentations/revealjs/examples/index.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/presentations/revealjs/presenting.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/presentations/revealjs/presenting.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/presentations/revealjs/themes.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/presentations/revealjs/themes.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/projects/virtual-environments.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/projects/virtual-environments.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/cells/cells-jupyter.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/cells/cells-jupyter.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/markdown/commonmark.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/markdown/commonmark.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/markdown/gfm.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/markdown/gfm.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/markdown/markua.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/markdown/markua.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/presentations/pptx.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/presentations/pptx.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/wiki/dokuwiki.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/wiki/dokuwiki.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/wiki/mediawiki.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/wiki/mediawiki.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/formats/wiki/zimwiki.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/formats/wiki/zimwiki.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/reference/projects/manuscripts.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/reference/projects/manuscripts.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/tools/_jupyter-lab-extension-install.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/tools/_jupyter-lab-extension-install.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
...
test_that("examples/quarto-web/docs/websites/website-listings-custom.qmd", {
  ast <- testthat::expect_no_error(parse_rmd(
    "examples/quarto-web/docs/websites/website-listings-custom.qmd"
  ), class = "rmd_ast")
  testthat::expect_equal(ast, parse_rmd(as_document(ast, padding = character())))
})
